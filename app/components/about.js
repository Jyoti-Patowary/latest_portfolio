        ...
        <div className={styles.container}>
          <div className={styles.aboutContent}>
            ...
            <div className={styles.textContainer}>
              ...
              <p className={styles.aboutText}>
              I'm a self-taught developer who found my passion for coding.  Even though I come from
                a different background in [Your Previous Field], I decided to take a chance and jump into the exciting world
                of coding. It's been challenging, but I'm learning and creating every day, and that's what keeps me going.
              </p>
              {/* <p className={styles.aboutText}>
